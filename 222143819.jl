...
model = machine(model, sale[:, ["Month"]],sale."Sales of shampoo over a three year period")
fit!(model,train_data)

# Make predictions on test data
pred= predict(model, sale[test_data,"Sales of shampoo over a three year period"])
